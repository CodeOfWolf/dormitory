...
<body th:inline="text">
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <li class="navbar-brand col-sm-3 col-md-2 mr-0">管理员:<%=session.getAttribute("adname")%></li>
        <input class="form-control form-control-dark w-100" type="text" placeholder="Search" aria-label="Search">
        <ul class="navbar-nav px-3">
          <li class="nav-item text-nowrap">
          <a class="nav-link" href="${pageContext.request.contextPath}/logout.do">注销</a>
          </li>
        </ul>
      </nav>
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
            ...
            <h2><a href="${pageContext.request.contextPath}/addstu.jsp" type="button" class="btn btn-success">添加</a></h2>
                ...
                <table class="table table-striped table-sm">
                    ...
                    <c:forEach var="i" items="${students}" >
                        <tr>
                        	...
                        	<td>${i.dname}</td>
                        	<td>
                        		<a href="${pageContext.request.contextPath}/findStudentBySno.do?sno=${i.sno}" type="button" class="btn btn-primary">编辑</a>
                        		<a href="${pageContext.request.contextPath}/deleteStudent.do?sno=${i.sno}" type="button" class="btn btn-danger">删除</a>
                        	</td>
                        </tr>
                     </c:forEach>
                     </tbody>
