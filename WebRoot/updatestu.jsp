        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
			<form action="" method="post">
			  <div class="form-group col-md-3">
			    ...
			    <input type="text" class="form-control" id="sno" name="sno" value="" placeholder="学号">
			  </div>
			  <div class="form-group col-md-3">
			    <label for="sname">姓名</label>
			    <input type="text" class="form-control" id="sname" name="sname" value="" placeholder="姓名">
			  </div>
			  <div class="form-group col-md-3">
			  ...
			  <div class="form-group col-md-3">
			    ...
			    <input type="text" class="form-control" id="sex" name="sex" value="" placeholder="性别">
			  </div>
			  <div class="form-group col-md-3">
			  ...
			  <div class="form-group col-md-3">
			    ...
			    <input type="text" class="form-control" id="tel" name="tel" value="" placeholder="手机号">
			  </div>
			  <div class="form-group col-md-3">
			    <label for="institute">学院</label>
			    <input type="text" class="form-control" id="institute" name="institute" value="" placeholder="学院">
			  </div>
			  <div class="form-group col-md-3">
			    <label for="majorname">专业</label>
			    <input type="text" class="form-control" id="majorname" name="majorname" value="" placeholder="专业">
			  </div>
			  <div class="form-group col-md-3">
			    <label for="grade">年级</label>
			    <input type="text" class="form-control" id="grade" name="grade" value="" placeholder="年级">
			  </div>
			  <div class="form-group col-md-3">
			    <label for="classname">班级</label>
			    <input type="text" class="form-control" id="classname" name="classname" value="" placeholder="班级">
			  </div>
			  <div class="form-group col-md-3">
